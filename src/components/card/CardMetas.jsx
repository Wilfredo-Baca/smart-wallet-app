  ...
  return (
    <div className="card">
      ...
      <div className="card-body">
        <p>
          <span className="point">&bull;</span>Monto Objetivo: {amount}
        </p>
        <p>
          <span className="point">&bull;</span>Nivel de Prioridad: {priority}
        </p>
        <p>
          <span className="point">&bull;</span>Fecha Inicio: {startDate}
        </p>
        <p>
          <span className="point">&bull;</span>Fecha Límite: {endDate}
        </p>
        <p>
          <span className="point">&bull;</span>Descripción: {description}
        </p>
        <Link
          to={`/metas/${id}`}
